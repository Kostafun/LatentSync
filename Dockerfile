...
# RUN uv run huggingface-cli download ByteDance/LatentSync-1.5 whisper/tiny.pt --local-dir checkpoints
# RUN uv run huggingface-cli download ByteDance/LatentSync-1.5 latentsync_unet.pt --local-dir checkpoints
RUN uv run huggingface-cli download ByteDance/LatentSync latentsync_unet.pt --local-dir checkpoints 
RUN uv run huggingface-cli download ByteDance/LatentSync whisper/tiny.pt --local-dir checkpoints 
